...
This project is part of a collection of reproducible machine learning pipelines.

- **Project GitHub Repository:** [animesh1012/machineLearning](https://github.com/animesh1012/machineLearning)
- **Original Kaggle Dataset:** [New Plant Diseases Dataset by @vipoooool](https://www.kaggle.com/datasets/vipoooool/new-plant-diseases-dataset)
- **Entire Project Source (Google Drive):** [Google Drive Folder Link](https://drive.google.com/drive/folders/YOUR_DRIVE_FOLDER_ID_HERE) *(Please replace this placeholder with your exact folder ID if distributing via Google Drive)*
